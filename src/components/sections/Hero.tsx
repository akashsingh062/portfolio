    ...
    <section id="hero" className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-center gap-12 mt-8 lg:mt-16">
      ...
      <div className="text-center lg:text-left space-y-6 max-w-2xl flex-1 lg:flex-none px-4 lg:px-0">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tight pb-2 select-none leading-[1.15] text-text-primary">
          Hi, I&apos;m{" "}
          <span className="relative inline-block bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent drop-shadow-[0_2px_20px_rgba(193,18,31,0.25)]">
            <TextAnimate
              animation="blurInUp"
              by="character"
              once
